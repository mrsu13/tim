...
// tim::mqtt_client&, что тянет в тест-бинарь mongoose + mbedTLS и весь
// MQTT-стек. Тесты handler-ов требуют боевого MQTT-брокера или
// специальной точки впрыска сообщений, которых сейчас нет. Поэтому здесь
