...
/**
 * Регистрирует общие Tcl-команды (универсальные, не связанные с
 * конкретным сервисом): /quit, /clear и т.п. в указанной LIL-сессии.
 * Сейчас это только `quit`; другие общие команды добавлять сюда.
 *
 * \param lil LIL-сессия.
 */
