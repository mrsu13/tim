...
// Public
/**
 * Конструирует сервис и регистрирует подписку. Оформление подписки
 * у брокера — в том числе после каждого восстановления соединения —
 * mqtt_client выполняет самостоятельно.
 *
